...
# TODO(@wchargin,@dandelionmane): Once `display_name` and
# `summary_description` land in core, use those first-class entities
# instead.
HistogramMetadata = collections.namedtuple(
  'HistogramMetadata', ('display_name', 'description'))


def create_summary_metadata(display_name, description):
  content = HistogramMetadata(display_name=display_name or '',
                              description=description or '')
  metadata = tf.SummaryMetadata()
  metadata.plugin_data.add(
